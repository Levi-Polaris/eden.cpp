...
struct server_context_meta {
    ...
    int slot_n_ctx;
    enum eden_pooling_type pooling_type;
    ...
    eden_token fim_pre_token;
    eden_token fim_sub_token;
    eden_token fim_mid_token;
    eden_token fim_pad_token;
    eden_token fim_rep_token;
    eden_token fim_sep_token;

    // sampling
    std::vector<eden_logit_bias> logit_bias_eog;

    // model meta
    enum eden_vocab_type model_vocab_type;
...
struct server_context {
    ...
    // get the underlaying eden_context, can return nullptr if sleeping
    // not thread-safe, should only be used from the main thread
    eden_context * get_eden_context() const;
