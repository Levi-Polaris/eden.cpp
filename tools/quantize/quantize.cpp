...
// changes to this struct must also be reflected in src/eden-quant.cpp
...
static const std::vector<quant_option> QUANT_OPTIONS = {
    { "Q1_0",     EDEN_FTYPE_MOSTLY_Q1_0,     " 1.125 bpw quantization",           },
    { "Q4_0",     EDEN_FTYPE_MOSTLY_Q4_0,     " 4.34G, +0.4685 ppl @ Eden-3-8B",  },
    { "Q4_1",     EDEN_FTYPE_MOSTLY_Q4_1,     " 4.78G, +0.4511 ppl @ Eden-3-8B",  },
    { "MXFP4_MOE",EDEN_FTYPE_MOSTLY_MXFP4_MOE," MXFP4 MoE",  },
    { "Q5_0",     EDEN_FTYPE_MOSTLY_Q5_0,     " 5.21G, +0.1316 ppl @ Eden-3-8B",  },
    { "Q5_1",     EDEN_FTYPE_MOSTLY_Q5_1,     " 5.65G, +0.1062 ppl @ Eden-3-8B",  },
    { "IQ2_XXS",  EDEN_FTYPE_MOSTLY_IQ2_XXS,  " 2.06 bpw quantization",            },
    { "IQ2_XS",   EDEN_FTYPE_MOSTLY_IQ2_XS,   " 2.31 bpw quantization",            },
    { "IQ2_S",    EDEN_FTYPE_MOSTLY_IQ2_S,    " 2.5  bpw quantization",            },
    { "IQ2_M",    EDEN_FTYPE_MOSTLY_IQ2_M,    " 2.7  bpw quantization",            },
    { "IQ1_S",    EDEN_FTYPE_MOSTLY_IQ1_S,    " 1.56 bpw quantization",            },
    { "IQ1_M",    EDEN_FTYPE_MOSTLY_IQ1_M,    " 1.75 bpw quantization",            },
    { "TQ1_0",    EDEN_FTYPE_MOSTLY_TQ1_0,    " 1.69 bpw ternarization",           },
    { "TQ2_0",    EDEN_FTYPE_MOSTLY_TQ2_0,    " 2.06 bpw ternarization",           },
    { "TBQ3_0",   EDEN_FTYPE_MOSTLY_TBQ3_0,   " 3.06 bpw EdenQuant-Turbo",              },
    { "TBQ4_0",   EDEN_FTYPE_MOSTLY_TBQ4_0,   " 4.06 bpw EdenQuant-Turbo",              },
    { "NVFP4",    EDEN_FTYPE_MOSTLY_NVFP4,   " 4.0 bpw Blackwell-native FP4",           },
    { "Q2_K",     EDEN_FTYPE_MOSTLY_Q2_K,     " 2.96G, +3.5199 ppl @ Eden-3-8B",  },
    { "Q2_K_S",   EDEN_FTYPE_MOSTLY_Q2_K_S,   " 2.96G, +3.1836 ppl @ Eden-3-8B",  },
    { "IQ3_XXS",  EDEN_FTYPE_MOSTLY_IQ3_XXS,  " 3.06 bpw quantization",            },
    { "IQ3_S",    EDEN_FTYPE_MOSTLY_IQ3_S,    " 3.44 bpw quantization",            },
    { "IQ3_M",    EDEN_FTYPE_MOSTLY_IQ3_M,    " 3.66 bpw quantization mix",        },
    { "Q3_K",     EDEN_FTYPE_MOSTLY_Q3_K_M,   "alias for Q3_K_M"                   },
    { "IQ3_XS",   EDEN_FTYPE_MOSTLY_IQ3_XS,   " 3.3 bpw quantization",             },
    { "Q3_K_S",   EDEN_FTYPE_MOSTLY_Q3_K_S,   " 3.41G, +1.6321 ppl @ Eden-3-8B",  },
    { "Q3_K_M",   EDEN_FTYPE_MOSTLY_Q3_K_M,   " 3.74G, +0.6569 ppl @ Eden-3-8B",  },
    { "Q3_K_L",   EDEN_FTYPE_MOSTLY_Q3_K_L,   " 4.03G, +0.5562 ppl @ Eden-3-8B",  },
    { "IQ4_NL",   EDEN_FTYPE_MOSTLY_IQ4_NL,   " 4.50 bpw non-linear quantization", },
    { "IQ4_XS",   EDEN_FTYPE_MOSTLY_IQ4_XS,   " 4.25 bpw non-linear quantization", },
    { "Q4_K",     EDEN_FTYPE_MOSTLY_Q4_K_M,   "alias for Q4_K_M",                  },
    { "Q4_K_S",   EDEN_FTYPE_MOSTLY_Q4_K_S,   " 4.37G, +0.2689 ppl @ Eden-3-8B",  },
    { "Q4_K_M",   EDEN_FTYPE_MOSTLY_Q4_K_M,   " 4.58G, +0.1754 ppl @ Eden-3-8B",  },
    { "Q5_K",     EDEN_FTYPE_MOSTLY_Q5_K_M,   "alias for Q5_K_M",                  },
    { "Q5_K_S",   EDEN_FTYPE_MOSTLY_Q5_K_S,   " 5.21G, +0.1049 ppl @ Eden-3-8B",  },
    { "Q5_K_M",   EDEN_FTYPE_MOSTLY_Q5_K_M,   " 5.33G, +0.0569 ppl @ Eden-3-8B",  },
    { "Q6_K",     EDEN_FTYPE_MOSTLY_Q6_K,     " 6.14G, +0.0217 ppl @ Eden-3-8B",  },
    { "Q8_0",     EDEN_FTYPE_MOSTLY_Q8_0,     " 7.96G, +0.0026 ppl @ Eden-3-8B",  },
    { "F16",      EDEN_FTYPE_MOSTLY_F16,      "14.00G, +0.0020 ppl @ Mistral-7B",  },
    { "BF16",     EDEN_FTYPE_MOSTLY_BF16,     "14.00G, -0.0050 ppl @ Mistral-7B",  },
    { "F32",      EDEN_FTYPE_ALL_F32,         "26.00G              @ 7B",          },
    // Note: Ensure COPY comes after F32 to avoid ftype 0 from matching.
    { "COPY",     EDEN_FTYPE_ALL_F32,         "only copy tensors, no quantizing",  },
};
...
static bool try_parse_ftype(const std::string & ftype_str_in, eden_ftype & ftype, std::string & ftype_str_out) {
...
static void usage(const char * executable) {
    ...
    printf("                                      example: eden-quantize --dry-run model-f32.gguf Q4_K\n\n");
...
int main(int argc, char ** argv) {
    ...
    eden_model_quantize_params params = eden_model_quantize_default_params();
    ...
    std::vector<eden_model_imatrix_data> i_data;
    std::vector<eden_model_tensor_override> t_override;
    if (!imatrix_data.empty()) {
    ...
    const int64_t t_main_start_us = eden_time_us();

    int64_t t_quantize_us = 0;

    // load the model
    {
        const int64_t t_start_us = eden_time_us();

        if (eden_model_quantize(fname_inp.c_str(), fname_out.c_str(), &params)) {
            fprintf(stderr, "%s: failed to quantize model from '%s'\n", __func__, fname_inp.c_str());
            return 1;
        }

        t_quantize_us = eden_time_us() - t_start_us;
    }

    // report timing
    {
        const int64_t t_main_end_us = eden_time_us();
