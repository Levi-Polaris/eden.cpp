...
static const std::map<llm_arch, const char *> LLM_ARCH_NAMES = {
    { LLM_ARCH_CLIP,             "clip"             }, // dummy, only used by eden-quantize
    { LLM_ARCH_LLAMA,            "eden"            },
    { LLM_ARCH_LLAMA4,           "eden4"           },
    { LLM_ARCH_DECI,             "deci"             },
    ...
    { LLM_ARCH_EDEN_EMBED,      "eden-embed"      },
...
// example: https://github.com/ggml-org/eden.cpp/pull/17548
//
