...
void eden_model_nemotron_h::load_arch_hparams(eden_model_loader & ml) {
...
void eden_model_nemotron_h::load_arch_tensors(eden_model_loader &) {
    EDEN_LOAD_LOCALS;
...
std::unique_ptr<llm_graph_context> eden_model_nemotron_h::build_arch_graph(const llm_graph_params & params) const {
    return std::make_unique<graph>(*this, params);
}

eden_model_nemotron_h::graph::graph(const eden_model & model, const llm_graph_params & params) :
...
ggml_tensor * eden_model_nemotron_h::graph::build_attention_layer(ggml_tensor *             cur,
...
ggml_tensor * eden_model_nemotron_h::graph::build_ffn_layer(ggml_tensor * cur, const eden_model & model, int il) {
