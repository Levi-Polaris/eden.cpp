...
void eden_model_gemma4::load_arch_hparams(eden_model_loader & ml) {
...
void eden_model_gemma4::load_arch_tensors(eden_model_loader &) {
    EDEN_LOAD_LOCALS;
...
std::unique_ptr<llm_graph_context> eden_model_gemma4::build_arch_graph(const llm_graph_params & params) const {
...
eden_model_gemma4::graph::graph(const eden_model & model, const llm_graph_params & params) :
...
ggml_tensor * eden_model_gemma4::graph::build_inp_per_layer() {
...
ggml_tensor * eden_model_gemma4::graph::project_per_layer_inputs(ggml_tensor * inp_batch, ggml_tensor * inp_per_layer) {
