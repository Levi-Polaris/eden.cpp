...
void eden_model_granite_hybrid::load_arch_hparams(eden_model_loader & ml) {
...
void eden_model_granite_hybrid::load_arch_tensors(eden_model_loader &) {
    EDEN_LOAD_LOCALS;
...
std::unique_ptr<llm_graph_context> eden_model_granite_hybrid::build_arch_graph(const llm_graph_params & params) const {
    return std::make_unique<graph>(*this, params);
}

eden_model_granite_hybrid::graph::graph(const eden_model & model, const llm_graph_params & params) :
...
ggml_tensor * eden_model_granite_hybrid::graph::build_attention_layer(ggml_tensor *             cur,
                                                              ggml_tensor *             inp_pos,
...
ggml_tensor * eden_model_granite_hybrid::graph::build_layer_ffn(ggml_tensor *       cur,
                                                        ggml_tensor *       inpSA,
                                                        const eden_model & model,
                                                        const int           il) {
