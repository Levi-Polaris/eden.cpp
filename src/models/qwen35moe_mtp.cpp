...
void eden_model_qwen35moe_mtp::load_arch_hparams(eden_model_loader & ml) {
...
void eden_model_qwen35moe_mtp::load_arch_tensors(eden_model_loader &) {
    EDEN_LOAD_LOCALS;
...
std::unique_ptr<llm_graph_context> eden_model_qwen35moe_mtp::build_arch_graph(const llm_graph_params & params) const {
    return std::make_unique<graph>(*this, params);
}

// LLM_ARCH_QWEN35MOE_MTP draft head for Qwen3.5/3.6 MoE
eden_model_qwen35moe_mtp::graph::graph(const eden_model & model, const llm_graph_params & params)
...
void eden_model_qwen35moe_mtp::link_shared_tensors(const eden_model * main_model) {
