...
void eden_model_plamo3::load_arch_hparams(eden_model_loader & ml) {
...
void eden_model_plamo3::load_arch_tensors(eden_model_loader &) {
    EDEN_LOAD_LOCALS;
...
std::unique_ptr<llm_graph_context> eden_model_plamo3::build_arch_graph(const llm_graph_params & params) const {
...
template <bool iswa>
eden_model_plamo3::graph<iswa>::graph(const eden_model & model, const llm_graph_params & params) :
...
template struct eden_model_plamo3::graph<false>;
template struct eden_model_plamo3::graph<true>;
