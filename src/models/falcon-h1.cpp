...
void eden_model_falcon_h1::load_arch_hparams(eden_model_loader & ml) {
    // Common parameters
...
void eden_model_falcon_h1::load_arch_tensors(eden_model_loader &) {
    EDEN_LOAD_LOCALS;
...
std::unique_ptr<llm_graph_context> eden_model_falcon_h1::build_arch_graph(const llm_graph_params & params) const {
    return std::make_unique<graph>(*this, params);
}

eden_model_falcon_h1::graph::graph(const eden_model & model, const llm_graph_params & params) :
