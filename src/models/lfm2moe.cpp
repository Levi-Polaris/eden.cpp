...
void eden_model_lfm2moe::load_arch_hparams(eden_model_loader & ml) {
...
void eden_model_lfm2moe::load_arch_tensors(eden_model_loader &) {
    EDEN_LOAD_LOCALS;
...
std::unique_ptr<llm_graph_context> eden_model_lfm2moe::build_arch_graph(const llm_graph_params & params) const {
