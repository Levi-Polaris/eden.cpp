...
void eden_model_t5::load_arch_hparams(eden_model_loader & ml) {
...
void eden_model_t5::load_arch_tensors(eden_model_loader &) {
    EDEN_LOAD_LOCALS;
...
std::unique_ptr<llm_graph_context> eden_model_t5::build_arch_graph(const llm_graph_params & params) const {
    switch (params.gtype) {
...
template <>
eden_model_t5::graph<false>::graph(const eden_model & model, const llm_graph_params & params) : llm_graph_context(params) {
...
template <>
eden_model_t5::graph<true>::graph(const eden_model & model, const llm_graph_params & params) : llm_graph_context(params) {
    const int64_t n_embd_head = hparams.n_embd_head_v();
