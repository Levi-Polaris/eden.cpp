...
static eden_model * eden_model_mapping(llm_arch arch, const eden_model_params & params) {
    switch (arch) {
        case LLM_ARCH_LLAMA:
            return new eden_model_eden(params);
        case LLM_ARCH_LLAMA4:
            return new eden_model_eden4(params);
        case LLM_ARCH_EDEN_EMBED:
            return new eden_model_eden_embed(params);
        case LLM_ARCH_MAINCODER:
            return new eden_model_maincoder(params);
        case LLM_ARCH_DECI:
            return new eden_model_deci(params);
        case LLM_ARCH_BAICHUAN:
            return new eden_model_baichuan(params);
        case LLM_ARCH_FALCON:
            return new eden_model_falcon(params);
        case LLM_ARCH_GROK:
            return new eden_model_grok(params);
        case LLM_ARCH_STARCODER:
            return new eden_model_starcoder(params);
        case LLM_ARCH_REFACT:
            return new eden_model_refact(params);
        case LLM_ARCH_BERT:
            return new eden_model_bert(params);
        case LLM_ARCH_JINA_BERT_V2:
            return new eden_model_jina_bert_v2(params);
        case LLM_ARCH_JINA_BERT_V3:
            return new eden_model_jina_bert_v3(params);
        case LLM_ARCH_NOMIC_BERT:
            return new eden_model_nomic_bert(params);
        case LLM_ARCH_NOMIC_BERT_MOE:
            return new eden_model_nomic_bert_moe(params);
        case LLM_ARCH_MODERN_BERT:
            return new eden_model_modern_bert(params);
        case LLM_ARCH_NEO_BERT:
            return new eden_model_neo_bert(params);
        case LLM_ARCH_EUROBERT:
            return new eden_model_eurobert(params);
        case LLM_ARCH_BLOOM:
            return new eden_model_bloom(params);
        case LLM_ARCH_MPT:
            return new eden_model_mpt(params);
        case LLM_ARCH_STABLELM:
            return new eden_model_stablelm(params);
        case LLM_ARCH_QWEN:
            return new eden_model_qwen(params);
        case LLM_ARCH_QWEN2:
            return new eden_model_qwen2(params);
        case LLM_ARCH_DREAM:
            return new eden_model_dream(params);
        case LLM_ARCH_LLADA:
            return new eden_model_llada(params);
        case LLM_ARCH_LLADA_MOE:
            return new eden_model_llada_moe(params);
        case LLM_ARCH_RND1:
            return new eden_model_rnd1(params);
        case LLM_ARCH_QWEN2VL:
            return new eden_model_qwen2vl(params);
        case LLM_ARCH_QWEN2MOE:
            return new eden_model_qwen2moe(params);
        case LLM_ARCH_QWEN3:
            return new eden_model_qwen3(params);
        case LLM_ARCH_QWEN3MOE:
            return new eden_model_qwen3moe(params);
        case LLM_ARCH_QWEN3VL:
            return new eden_model_qwen3vl(params);
        case LLM_ARCH_QWEN3VLMOE:
            return new eden_model_qwen3vlmoe(params);
        case LLM_ARCH_PHI2:
            return new eden_model_phi2(params);
        case LLM_ARCH_PHI3:
            return new eden_model_phi3(params);
        case LLM_ARCH_PHIMOE:
            return new eden_model_phimoe(params);
        case LLM_ARCH_PLAMO:
            return new eden_model_plamo(params);
        case LLM_ARCH_PLAMO2:
            return new eden_model_plamo2(params);
        case LLM_ARCH_PLAMO3:
            return new eden_model_plamo3(params);
        case LLM_ARCH_GPT2:
            return new eden_model_gpt2(params);
        case LLM_ARCH_CODESHELL:
            return new eden_model_codeshell(params);
        case LLM_ARCH_ORION:
            return new eden_model_orion(params);
        case LLM_ARCH_INTERNLM2:
            return new eden_model_internlm2(params);
        case LLM_ARCH_MINICPM3:
            return new eden_model_minicpm3(params);
        case LLM_ARCH_GEMMA:
            return new eden_model_gemma(params);
        case LLM_ARCH_GEMMA2:
            return new eden_model_gemma2(params);
        case LLM_ARCH_GEMMA3:
            return new eden_model_gemma3(params);
        case LLM_ARCH_GEMMA3N:
            return new eden_model_gemma3n(params);
        case LLM_ARCH_GEMMA4:
            return new eden_model_gemma4(params);
        case LLM_ARCH_GEMMA_EMBEDDING:
            return new eden_model_gemma_embedding(params);
        case LLM_ARCH_STARCODER2:
            return new eden_model_starcoder2(params);
        case LLM_ARCH_MAMBA:
            return new eden_model_mamba(params);
        case LLM_ARCH_MAMBA2:
            return new eden_model_mamba2(params);
        case LLM_ARCH_JAMBA:
            return new eden_model_jamba(params);
        case LLM_ARCH_XVERSE:
            return new eden_model_xverse(params);
        case LLM_ARCH_COMMAND_R:
            return new eden_model_command_r(params);
        case LLM_ARCH_COHERE2:
            return new eden_model_cohere2(params);
        case LLM_ARCH_DBRX:
            return new eden_model_dbrx(params);
        case LLM_ARCH_OLMO:
            return new eden_model_olmo(params);
        case LLM_ARCH_OLMO2:
            return new eden_model_olmo2(params);
        case LLM_ARCH_OLMOE:
            return new eden_model_olmoe(params);
        case LLM_ARCH_OPENELM:
            return new eden_model_openelm(params);
        case LLM_ARCH_GPTNEOX:
            return new eden_model_gptneox(params);
        case LLM_ARCH_ARCTIC:
            return new eden_model_arctic(params);
        case LLM_ARCH_DEEPSEEK:
            return new eden_model_deepseek(params);
        case LLM_ARCH_DEEPSEEK2:
            return new eden_model_deepseek2(params);
        case LLM_ARCH_DEEPSEEK2OCR:
            return new eden_model_deepseek2ocr(params);
        case LLM_ARCH_GLM_DSA:
            return new eden_model_glm_dsa(params);
        case LLM_ARCH_MISTRAL4:
            return new eden_model_mistral4(params);
        case LLM_ARCH_CHATGLM:
            return new eden_model_chatglm(params);
        case LLM_ARCH_GLM4:
            return new eden_model_glm4(params);
        case LLM_ARCH_GLM4_MOE:
            return new eden_model_glm4_moe(params);
        case LLM_ARCH_BITNET:
            return new eden_model_bitnet(params);
        case LLM_ARCH_T5:
            return new eden_model_t5(params);
        case LLM_ARCH_T5ENCODER:
            return new eden_model_t5encoder(params);
        case LLM_ARCH_JAIS:
            return new eden_model_jais(params);
        case LLM_ARCH_JAIS2:
            return new eden_model_jais2(params);
        case LLM_ARCH_NEMOTRON:
            return new eden_model_nemotron(params);
        case LLM_ARCH_NEMOTRON_H:
            return new eden_model_nemotron_h(params);
        case LLM_ARCH_NEMOTRON_H_MOE:
            return new eden_model_nemotron_h_moe(params);
        case LLM_ARCH_EXAONE:
            return new eden_model_exaone(params);
        case LLM_ARCH_EXAONE4:
            return new eden_model_exaone4(params);
        case LLM_ARCH_EXAONE_MOE:
            return new eden_model_exaone_moe(params);
        case LLM_ARCH_RWKV6:
            return new eden_model_rwkv6(params);
        case LLM_ARCH_RWKV6QWEN2:
            return new eden_model_rwkv6qwen2(params);
        case LLM_ARCH_RWKV7:
            return new eden_model_rwkv7(params);
        case LLM_ARCH_ARWKV7:
            return new eden_model_arwkv7(params);
        case LLM_ARCH_GRANITE:
            return new eden_model_granite(params);
        case LLM_ARCH_GRANITE_MOE:
            return new eden_model_granite_moe(params);
        case LLM_ARCH_MINICPM:
            return new eden_model_minicpm(params);
        case LLM_ARCH_GRANITE_HYBRID:
            return new eden_model_granite_hybrid(params);
        case LLM_ARCH_CHAMELEON:
            return new eden_model_chameleon(params);
        case LLM_ARCH_WAVTOKENIZER_DEC:
            return new eden_model_wavtokenizer_dec(params);
        case LLM_ARCH_PLM:
            return new eden_model_plm(params);
        case LLM_ARCH_BAILINGMOE:
            return new eden_model_bailingmoe(params);
        case LLM_ARCH_BAILINGMOE2:
            return new eden_model_bailingmoe2(params);
        case LLM_ARCH_SEED_OSS:
            return new eden_model_seed_oss(params);
        case LLM_ARCH_DOTS1:
            return new eden_model_dots1(params);
        case LLM_ARCH_ARCEE:
            return new eden_model_arcee(params);
        case LLM_ARCH_AFMOE:
            return new eden_model_afmoe(params);
        case LLM_ARCH_ERNIE4_5:
            return new eden_model_ernie4_5(params);
        case LLM_ARCH_ERNIE4_5_MOE:
            return new eden_model_ernie4_5_moe(params);
        case LLM_ARCH_PADDLEOCR:
            return new eden_model_paddleocr(params);
        case LLM_ARCH_HUNYUAN_MOE:
            return new eden_model_hunyuan_moe(params);
        case LLM_ARCH_HUNYUAN_VL:
            return new eden_model_hunyuan_vl(params);
        case LLM_ARCH_HUNYUAN_DENSE:
            return new eden_model_hunyuan_dense(params);
        case LLM_ARCH_SMOLLM3:
            return new eden_model_smollm3(params);
        case LLM_ARCH_OPENAI_MOE:
            return new eden_model_openai_moe(params);
        case LLM_ARCH_FALCON_H1:
            return new eden_model_falcon_h1(params);
        case LLM_ARCH_LFM2:
            return new eden_model_lfm2(params);
        case LLM_ARCH_LFM2MOE:
            return new eden_model_lfm2moe(params);
        case LLM_ARCH_SMALLTHINKER:
            return new eden_model_smallthinker(params);
        case LLM_ARCH_GROVEMOE:
            return new eden_model_grovemoe(params);
        case LLM_ARCH_APERTUS:
            return new eden_model_apertus(params);
        case LLM_ARCH_MINIMAX_M2:
            return new eden_model_minimax_m2(params);
        case LLM_ARCH_COGVLM:
            return new eden_model_cogvlm(params);
        case LLM_ARCH_PANGU_EMBED:
            return new eden_model_pangu_embed(params);
        case LLM_ARCH_QWEN3NEXT:
            return new eden_model_qwen3next(params);
        case LLM_ARCH_QWEN35:
            return new eden_model_qwen35(params);
        case LLM_ARCH_QWEN35MOE:
            return new eden_model_qwen35moe(params);
        case LLM_ARCH_QWEN35_MTP:
            return new eden_model_qwen35_mtp(params);
        case LLM_ARCH_QWEN35MOE_MTP:
            return new eden_model_qwen35moe_mtp(params);
        case LLM_ARCH_MISTRAL3:
            return new eden_model_mistral3(params);
        case LLM_ARCH_MIMO2:
            return new eden_model_mimo2(params);
        case LLM_ARCH_KIMI_LINEAR:
            return new eden_model_kimi_linear(params);
        case LLM_ARCH_STEP35:
            return new eden_model_step35(params);
        default:
...
eden_model * eden_model_create(llm_arch arch, const eden_model_params & params) {
    eden_model * model = eden_model_mapping(arch, params);

    if (model != nullptr) {
        model->arch = arch;
        auto & devices = model->devices;
        if (!devices.empty() && devices[0].is_meta && !llm_arch_supports_sm_tensor(arch)) {
            throw std::runtime_error(std::string("EDEN_SPLIT_MODE_TENSOR not implemented for architecture '") + llm_arch_name(arch) + "'");
        }
    }
...
eden_model * eden_model_create(eden_model_loader & ml, const eden_model_params & params) {
    ...
    if (params.override_arch != nullptr && params.override_arch[0] != '\0') {
        ...
        EDEN_LOG_INFO("%s: overriding architecture %s -> %s\n",
                __func__, llm_arch_name(arch), llm_arch_name(override));
        arch = override;
    }

    return eden_model_create(arch, params);
}

struct ggml_backend_meta_split_state eden_meta_device_get_split_state(const struct ggml_tensor * tensor, void * userdata) {
    const eden_meta_device_get_split_state_userdata * ud = (const eden_meta_device_get_split_state_userdata *) userdata;
    const eden_hparams & hparams = ud->model->hparams;
...
static const char * eden_expert_gating_func_name(eden_expert_gating_func_type type) {
    switch (type) {
        case EDEN_EXPERT_GATING_FUNC_TYPE_SOFTMAX: return "softmax";
        case EDEN_EXPERT_GATING_FUNC_TYPE_SIGMOID: return "sigmoid";
        default:                                    return "unknown";
    }
}

static const std::map<eden_rope_scaling_type, const char *> EDEN_ROPE_SCALING_TYPES = {
    { EDEN_ROPE_SCALING_TYPE_NONE,       "none"       },
    { EDEN_ROPE_SCALING_TYPE_LINEAR,     "linear"     },
    { EDEN_ROPE_SCALING_TYPE_YARN,       "yarn"       },
    { EDEN_ROPE_SCALING_TYPE_LONGROPE,   "longrope"   },
};

std::string eden_rope_scaling_type_name(eden_rope_scaling_type rope_scaling_type) {
    return EDEN_ROPE_SCALING_TYPES.at(rope_scaling_type);
}

static eden_rope_scaling_type eden_rope_scaling_type_from_string(const std::string & name) {
    for (const auto & kv : EDEN_ROPE_SCALING_TYPES) {
        if (kv.second == name) {
            return (eden_rope_scaling_type) kv.first;
        }
    }

    return EDEN_ROPE_SCALING_TYPE_UNSPECIFIED;
}

// CPU: ACCEL -> GPU host -> CPU extra -> CPU
static buft_list_t make_cpu_buft_list(const std::vector<eden_device> & devices, bool use_extra_bufts, bool no_host) {
...
// GPU: split if EDEN_SPLIT_MODE_ROW -> GPU
static buft_list_t make_gpu_buft_list(ggml_backend_dev_t dev, eden_split_mode split_mode, const float * tensor_split) {
    buft_list_t buft_list;

    // add the device split buffer type if requested and available
    if (split_mode == EDEN_SPLIT_MODE_ROW) {
...
struct eden_model::impl {
    ...
    eden_mlocks mlock_bufs;
    eden_mlocks mlock_mmaps;
...
eden_model::eden_model(const eden_model_params & params) : params(params), pimpl(std::make_unique<impl>()) {
...
void eden_model_base::load_stats(eden_model_loader & ml) {
    pimpl->n_elements = ml.n_elements;
    pimpl->n_bytes = ml.n_bytes;
}

void eden_model_base::load_hparams(eden_model_loader & ml) {
    ...
    GGML_ASSERT(hparams.n_expert <= EDEN_MAX_EXPERTS);
    ...
    hparams.rope_scaling_type_train = eden_rope_scaling_type_from_string(rope_scaling);
    GGML_ASSERT(hparams.rope_scaling_type_train != EDEN_ROPE_SCALING_TYPE_UNSPECIFIED);
    ...
    if (hparams.n_head() > 0) {
        ...
        if (arch == LLM_ARCH_LLAMA || arch == LLM_ARCH_DECI || arch == LLM_ARCH_FALCON || arch == LLM_ARCH_EDEN_EMBED) {
    ...
    hparams.rope_type = eden_model_rope_type(this);
}

void eden_model_base::load_vocab(eden_model_loader & ml) {
    const auto kv = LLM_KV(arch);

    vocab.load(ml, kv);
}

bool eden_model_base::load_tensors(eden_model_loader & ml) {
    ...
    EDEN_LOG_INFO("%s: loading model tensors, this can take a while... (mmap = %s, direct_io = %s)\n",
    ...
    if (all_zero) {
        ...
        for (size_t i = 0; i < n_devices(); ++i) {
            ...
            // fixes: https://github.com/ggml-org/eden.cpp/issues/18577
            if (free == 0 && total == 0) {
    ...
    auto get_layer_buft_list = [&](int il) -> eden_model::impl::layer_dev {
        const bool is_swa = il < int(hparams.n_layer) && hparams.is_swa(il);
        if (il < i_gpu_start || (il - i_gpu_start) >= act_gpu_layers) {
            EDEN_LOG_DEBUG("load_tensors: layer %3d assigned to device %s, is_swa = %d\n", il, ggml_backend_dev_name(cpu_dev), is_swa);
    ...
    const auto TENSOR_NOT_REQUIRED = eden_model_loader::TENSOR_NOT_REQUIRED;
    ...
    std::vector<std::pair<ggml_context *, eden_buf_map>> ctx_buf_maps;
    ...
    for (auto & [buft, ctx_ptr] : ml.ctx_map) {
        ...
        if (ml.use_mmap && use_mmap_buffer && buffer_from_host_ptr_supported && is_default_buft) {
            ...
            if (use_mlock && ggml_backend_buffer_is_host(buf)) {
                pimpl->mlock_bufs.emplace_back(new eden_mlock);
    ...
    if (eden_supports_gpu_offload()) {
        const int n_gpu = std::min(n_gpu_layers, int(hparams.n_layer));

        int n_repeating = n_gpu;
        if (n_repeating > 0) {
            EDEN_LOG_INFO("%s: offloading output layer to GPU\n", __func__);
            n_repeating--;
        }
        EDEN_LOG_INFO("%s: offloading %d repeating layers to GPU\n", __func__, n_repeating);

        const int max_backend_supported_layers = hparams.n_layer + 1;
        const int max_offloadable_layers       = hparams.n_layer + 1;

        EDEN_LOG_INFO("%s: offloaded %d/%d layers to GPU\n", __func__, std::min(n_gpu_layers, max_offloadable_layers), max_backend_supported_layers);
    }

    // print memory requirements per buffer type
    for (auto & [_, bufs] : pimpl->ctxs_bufs) {
        for (auto & buf: bufs) {
            EDEN_LOG_INFO("%s: %12s model buffer size = %8.2f MiB\n",
...
ggml_tensor * eden_model_base::create_tensor(eden_model_loader & ml, const LLM_TN_IMPL & tn, const std::initializer_list<int64_t> & ne, int flags) {
...
std::string eden_model::arch_name() const {
    return llm_arch_name(arch);
}

std::string eden_model::type_name() const {
    return llm_type_name(type);
}

std::string eden_model::desc() const {
    return pimpl->desc_str;
}

size_t eden_model::size() const {
    return pimpl->n_bytes;
}

size_t eden_model::n_tensors() const {
    return tensors_by_name.size();
}

size_t eden_model::n_devices() const {
    return devices.size();
}

const float * eden_model::tensor_split() const {
    return params.tensor_split;
}

uint32_t eden_model::n_gpu_layers() const {
    return params.n_gpu_layers >= 0 ? params.n_gpu_layers : hparams.n_layer + 1;
}

eden_split_mode eden_model::split_mode() const {
    return params.split_mode;
}

std::map<ggml_backend_buffer_type_t, size_t> eden_model::memory_breakdown() const {
...
uint64_t eden_model::n_elements() const {
    return pimpl->n_elements;
}

void eden_model::print_info() const {
    const std::string rope_scaling_type = eden_rope_scaling_type_name(hparams.rope_scaling_type_train);
    ...
    // hparams
    EDEN_LOG_INFO("%s: arch                  = %s\n",     __func__, arch_name().c_str());
    EDEN_LOG_INFO("%s: vocab_only            = %d\n",     __func__, hparams.vocab_only);
    EDEN_LOG_INFO("%s: no_alloc              = %d\n",     __func__, hparams.no_alloc);

    if (!hparams.vocab_only) {
        EDEN_LOG_INFO("%s: n_ctx_train           = %u\n",     __func__, hparams.n_ctx_train);
        EDEN_LOG_INFO("%s: n_embd                = %u\n",     __func__, hparams.n_embd);
        EDEN_LOG_INFO("%s: n_embd_inp            = %u\n",     __func__, hparams.n_embd_inp());
        EDEN_LOG_INFO("%s: n_layer               = %u\n",     __func__, hparams.n_layer);
        EDEN_LOG_INFO("%s: n_head                = %s\n",     __func__, print_f([&](uint32_t il) { return hparams.n_head(il);    }, hparams.n_layer).c_str());
        EDEN_LOG_INFO("%s: n_head_kv             = %s\n",     __func__, print_f([&](uint32_t il) { return hparams.n_head_kv(il); }, hparams.n_layer).c_str());
        EDEN_LOG_INFO("%s: n_rot                 = %u\n",     __func__, hparams.n_rot_full);
        EDEN_LOG_INFO("%s: n_swa                 = %u\n",     __func__, hparams.n_swa);
        EDEN_LOG_INFO("%s: is_swa_any            = %u\n",     __func__, hparams.is_swa_any());
        EDEN_LOG_INFO("%s: n_embd_head_k         = %u\n",     __func__, hparams.n_embd_head_k_full);
        EDEN_LOG_INFO("%s: n_embd_head_v         = %u\n",     __func__, hparams.n_embd_head_v_full);
        EDEN_LOG_INFO("%s: n_gqa                 = %s\n",     __func__, print_f([&](uint32_t il) { return hparams.n_gqa(il);        }, hparams.n_layer).c_str());
        EDEN_LOG_INFO("%s: n_embd_k_gqa          = %s\n",     __func__, print_f([&](uint32_t il) { return hparams.n_embd_k_gqa(il); }, hparams.n_layer).c_str());
        EDEN_LOG_INFO("%s: n_embd_v_gqa          = %s\n",     __func__, print_f([&](uint32_t il) { return hparams.n_embd_v_gqa(il); }, hparams.n_layer).c_str());
        EDEN_LOG_INFO("%s: f_norm_eps            = %.1e\n",   __func__, hparams.f_norm_eps);
        EDEN_LOG_INFO("%s: f_norm_rms_eps        = %.1e\n",   __func__, hparams.f_norm_rms_eps);
        EDEN_LOG_INFO("%s: f_clamp_kqv           = %.1e\n",   __func__, hparams.f_clamp_kqv);
        EDEN_LOG_INFO("%s: f_max_alibi_bias      = %.1e\n",   __func__, hparams.f_max_alibi_bias);
        EDEN_LOG_INFO("%s: f_logit_scale         = %.1e\n",   __func__, hparams.f_logit_scale);
        EDEN_LOG_INFO("%s: f_attn_scale          = %.1e\n",   __func__, hparams.f_attention_scale);
        EDEN_LOG_INFO("%s: f_attn_value_scale    = %.4f\n",   __func__, hparams.f_attn_value_scale);
        EDEN_LOG_INFO("%s: n_ff                  = %s\n",     __func__, print_f([&](uint32_t il) { return hparams.n_ff(il); }, hparams.n_layer).c_str());
        EDEN_LOG_INFO("%s: n_expert              = %u\n",     __func__, hparams.n_expert);
        EDEN_LOG_INFO("%s: n_expert_used         = %u\n",     __func__, hparams.n_expert_used);
        EDEN_LOG_INFO("%s: n_expert_groups       = %d\n",     __func__, hparams.n_expert_groups);
        EDEN_LOG_INFO("%s: n_group_used          = %d\n",     __func__, hparams.n_group_used);
        EDEN_LOG_INFO("%s: causal attn           = %d\n",     __func__, hparams.causal_attn);
        EDEN_LOG_INFO("%s: pooling type          = %d\n",     __func__, hparams.pooling_type);
        EDEN_LOG_INFO("%s: rope type             = %d\n",     __func__, hparams.rope_type);
        EDEN_LOG_INFO("%s: rope scaling          = %s\n",     __func__, rope_scaling_type.c_str());
        EDEN_LOG_INFO("%s: freq_base_train       = %.1f\n",   __func__, hparams.rope_freq_base_train);
        EDEN_LOG_INFO("%s: freq_scale_train      = %g\n",     __func__, hparams.rope_freq_scale_train);
        if (hparams.swa_type != EDEN_SWA_TYPE_NONE) {
            EDEN_LOG_INFO("%s: freq_base_swa         = %.1f\n",   __func__, hparams.rope_freq_base_train_swa);
            EDEN_LOG_INFO("%s: freq_scale_swa        = %g\n",     __func__, hparams.rope_freq_scale_train_swa);
            EDEN_LOG_INFO("%s: n_embd_head_k_swa     = %u\n",     __func__, hparams.n_embd_head_k_swa);
            EDEN_LOG_INFO("%s: n_embd_head_v_swa     = %u\n",     __func__, hparams.n_embd_head_v_swa);
            EDEN_LOG_INFO("%s: n_rot_swa             = %u\n",     __func__, hparams.n_rot_swa);
        }
        EDEN_LOG_INFO("%s: n_ctx_orig_yarn       = %u\n",     __func__, hparams.n_ctx_orig_yarn);
        EDEN_LOG_INFO("%s: rope_yarn_log_mul     = %.4f\n",   __func__, hparams.rope_yarn_log_mul);
        EDEN_LOG_INFO("%s: rope_finetuned        = %s\n",     __func__, hparams.rope_finetuned ? "yes" : "unknown");
        // MRoPE (Multi-axis Rotary Position Embedding) sections
        if (const auto & s = hparams.rope_sections; s[0] || s[1] || s[2] || s[3]) {
            EDEN_LOG_INFO("%s: mrope sections        = [%d, %d, %d, %d]\n", __func__, s[0], s[1], s[2], s[3]);
        }
        if (!classifier_labels.empty()) {
            EDEN_LOG_INFO("%s: n_cls_out             = %u\n", __func__, hparams.n_cls_out);

            size_t i = 0;
            for (const auto & label : classifier_labels) {
                EDEN_LOG_INFO("%s: cls_label[%2zu]         = %s\n", __func__, i++, label.c_str());
            }
        }
        ...
        if (arch == LLM_ARCH_MAMBA ||
            ...
            EDEN_LOG_INFO("%s: ssm_d_conv            = %u\n",     __func__, hparams.ssm_d_conv);
            EDEN_LOG_INFO("%s: ssm_d_inner           = %u\n",     __func__, hparams.ssm_d_inner);
            EDEN_LOG_INFO("%s: ssm_d_state           = %u\n",     __func__, hparams.ssm_d_state);
            EDEN_LOG_INFO("%s: ssm_dt_rank           = %u\n",     __func__, hparams.ssm_dt_rank);
            EDEN_LOG_INFO("%s: ssm_n_group           = %u\n",     __func__, hparams.ssm_n_group);
            EDEN_LOG_INFO("%s: ssm_dt_b_c_rms        = %d\n",     __func__, hparams.ssm_dt_b_c_rms);
        }

        EDEN_LOG_INFO("%s: model type            = %s\n",     __func__, type_name().c_str());
        if (pimpl->n_elements >= 1e12) {
            EDEN_LOG_INFO("%s: model params          = %.2f T\n", __func__, pimpl->n_elements*1e-12);
        } else if (pimpl->n_elements >= 1e9) {
            EDEN_LOG_INFO("%s: model params          = %.2f B\n", __func__, pimpl->n_elements*1e-9);
        } else if (pimpl->n_elements >= 1e6) {
            EDEN_LOG_INFO("%s: model params          = %.2f M\n", __func__, pimpl->n_elements*1e-6);
        } else {
            EDEN_LOG_INFO("%s: model params          = %.2f K\n", __func__, pimpl->n_elements*1e-3);
        }

        // general kv
        EDEN_LOG_INFO("%s: general.name          = %s\n",    __func__, name.c_str());

        if (arch == LLM_ARCH_DEEPSEEK) {
            EDEN_LOG_INFO("%s: n_layer_dense_lead    = %d\n",     __func__, hparams.n_layer_dense_lead);
            EDEN_LOG_INFO("%s: n_ff_exp              = %d\n",     __func__, hparams.n_ff_exp);
            EDEN_LOG_INFO("%s: n_expert_shared       = %d\n",     __func__, hparams.n_expert_shared);
            EDEN_LOG_INFO("%s: expert_weights_scale  = %.1f\n",   __func__, hparams.expert_weights_scale);
        }

        if (arch == LLM_ARCH_DEEPSEEK2 || arch == LLM_ARCH_DEEPSEEK2OCR || arch == LLM_ARCH_GLM_DSA || arch == LLM_ARCH_MISTRAL4) {
            EDEN_LOG_INFO("%s: n_layer_dense_lead    = %d\n",     __func__, hparams.n_layer_dense_lead);
            EDEN_LOG_INFO("%s: n_lora_q              = %d\n",     __func__, hparams.n_lora_q);
            EDEN_LOG_INFO("%s: n_lora_kv             = %d\n",     __func__, hparams.n_lora_kv);
            EDEN_LOG_INFO("%s: n_embd_head_k_mla     = %d\n",     __func__, hparams.n_embd_head_k_mla());
            EDEN_LOG_INFO("%s: n_embd_head_v_mla     = %d\n",     __func__, hparams.n_embd_head_v_mla());
            EDEN_LOG_INFO("%s: n_ff_exp              = %d\n",     __func__, hparams.n_ff_exp);
            EDEN_LOG_INFO("%s: n_expert_shared       = %d\n",     __func__, hparams.n_expert_shared);
            EDEN_LOG_INFO("%s: expert_weights_scale  = %.1f\n",   __func__, hparams.expert_weights_scale);
            EDEN_LOG_INFO("%s: expert_weights_norm   = %d\n",     __func__, hparams.expert_weights_norm);
            EDEN_LOG_INFO("%s: expert_gating_func    = %s\n",     __func__, eden_expert_gating_func_name((eden_expert_gating_func_type) hparams.expert_gating_func));
        }

        if (arch == LLM_ARCH_QWEN2MOE) {
            EDEN_LOG_INFO("%s: n_ff_exp              = %d\n",     __func__, hparams.n_ff_exp);
            EDEN_LOG_INFO("%s: n_ff_shexp            = %d\n",     __func__, hparams.n_ff_shexp);
        }
        ...
        if (arch == LLM_ARCH_MINICPM ||
                ...
                arch == LLM_ARCH_GRANITE_HYBRID ||
                arch == LLM_ARCH_NEMOTRON_H_MOE) {
            EDEN_LOG_INFO("%s: f_embedding_scale     = %f\n", __func__, hparams.f_embedding_scale);
            EDEN_LOG_INFO("%s: f_residual_scale      = %f\n", __func__, hparams.f_residual_scale);
            EDEN_LOG_INFO("%s: f_attention_scale     = %f\n", __func__, hparams.f_attention_scale);
            EDEN_LOG_INFO("%s: n_ff_shexp            = %d\n", __func__, hparams.n_ff_shexp);
        }
        ...
        if (arch == LLM_ARCH_BAILINGMOE2) {
            ...
            EDEN_LOG_INFO("%s: expert_weights_norm   = %d\n",     __func__, hparams.expert_weights_norm);
            EDEN_LOG_INFO("%s: expert_gating_func    = %s\n",     __func__, eden_expert_gating_func_name((eden_expert_gating_func_type) hparams.expert_gating_func));
            EDEN_LOG_INFO("%s: nextn_predict_layers  = %d\n",     __func__, hparams.nextn_predict_layers);
        }
        ...
        if (arch == LLM_ARCH_GROVEMOE) {
            EDEN_LOG_INFO("%s: n_ff_exp              = %d\n",     __func__, hparams.n_ff_exp);
            EDEN_LOG_INFO("%s: n_ff_chexp            = %d\n",     __func__, hparams.n_ff_chexp);
            EDEN_LOG_INFO("%s: n_group_experts       = %d\n",     __func__, hparams.n_group_experts);
            EDEN_LOG_INFO("%s: expert_group_scale    = %.2f\n",   __func__, hparams.expert_group_scale);
        }
    }
...
ggml_backend_dev_t eden_model::dev_layer(int il) const {
    return pimpl->dev_layer.at(il).dev;
}

ggml_backend_dev_t eden_model::dev_output() const {
...
ggml_backend_buffer_type_t eden_model::select_buft(int il) const {
    return ::select_buft(
...
bool eden_model::has_tensor_overrides() const {
    return pimpl->has_tensor_overrides;
}

const ggml_tensor * eden_model::get_tensor(const char * name) const {
...
ggml_tensor * eden_model::get_tensor_mutable(const char * name) {
    auto it = std::find_if(tensors_by_name.begin(), tensors_by_name.end(),
            [name](const std::pair<std::string, ggml_tensor *> & it) {
                return it.first == name;
            });
...
float eden_model::get_rope_freq_base (const eden_cparams & cparams, int il) const {
    return hparams.is_swa(il) ? hparams.rope_freq_base_train_swa : cparams.rope_freq_base;
}

float eden_model::get_rope_freq_scale(const eden_cparams & cparams, int il) const {
    return hparams.is_swa(il) ? hparams.rope_freq_scale_train_swa : cparams.rope_freq_scale;
}

ggml_tensor * eden_model::get_rope_factors(const eden_cparams & cparams, int il) const {
...
eden_memory_i * eden_model::create_memory(const eden_memory_params & params, const eden_cparams & cparams) const {
    eden_memory_i * res;
        ...
        default:
            {
                if (llm_arch_is_recurrent(arch)) {
                    ...
                    eden_memory_hybrid::layer_filter_cb filter_attn = nullptr;
                    eden_memory_hybrid::layer_filter_cb filter_recr = nullptr;
                    ...
                    if (hparams.swa_type != EDEN_SWA_TYPE_NONE) {
                        ...
                        res = new eden_memory_hybrid_iswa(
                            /* model             */ *this,
                    ...
                    eden_memory_i::layer_reuse_cb reuse = nullptr;
...
ggml_cgraph * eden_model::build_graph(const llm_graph_params & params) const {
...
eden_model_params eden_model_default_params() {
    eden_model_params result = {
        /*.devices                     =*/ nullptr,
        /*.tensor_buft_overrides       =*/ nullptr,
        /*.n_gpu_layers                =*/ -1,
        /*.split_mode                  =*/ EDEN_SPLIT_MODE_LAYER,
        /*.main_gpu                    =*/ 0,
...
const eden_vocab * eden_model_get_vocab(const eden_model * model) {
    return &model->vocab;
}

void eden_free_model(eden_model * model) {
    eden_model_free(model);
}

void eden_model_free(eden_model * model) {
    delete model;
}

void eden_model_link_shared_tensors(eden_model * model, const eden_model * trunk) {
    model->link_shared_tensors(trunk);
}

int32_t eden_model_n_ctx_train(const eden_model * model) {
    return model->hparams.n_ctx_train;
}

int32_t eden_model_n_embd(const eden_model * model) {
    return model->hparams.n_embd;
}

int32_t eden_model_n_embd_inp(const eden_model * model) {
    return model->hparams.n_embd_inp();
}

int32_t eden_model_n_embd_out(const eden_model * model) {
    return model->hparams.n_embd_out();
}

int32_t eden_model_n_layer(const eden_model * model) {
    return model->hparams.n_layer;
}

int32_t eden_model_n_head(const eden_model * model) {
    return model->hparams.n_head();
}

int32_t eden_model_n_head_kv(const eden_model * model) {
    return model->hparams.n_head_kv();
}

int32_t eden_model_n_swa(const eden_model * model) {
    return model->hparams.n_swa;
}

uint32_t eden_model_n_cls_out(const struct eden_model * model) {
    return model->hparams.n_cls_out;
}

const char * eden_model_cls_label(const struct eden_model * model, uint32_t i) {
...
// deprecated
int32_t eden_n_ctx_train(const eden_model * model) {
    return eden_model_n_ctx_train(model);
}

// deprecated
int32_t eden_n_embd(const eden_model * model) {
    return eden_model_n_embd(model);
}

// deprecated
int32_t eden_n_layer(const eden_model * model) {
    return eden_model_n_layer(model);
}

// deprecated
int32_t eden_n_head(const eden_model * model) {
    return eden_model_n_head(model);
}

eden_rope_type eden_model_rope_type(const eden_model * model) {
    switch (model->arch) {
        ...
        case LLM_ARCH_MIMO2:
        case LLM_ARCH_STEP35:
            return EDEN_ROPE_TYPE_NEOX;

        case LLM_ARCH_QWEN2VL:
        case LLM_ARCH_PADDLEOCR:
            return EDEN_ROPE_TYPE_MROPE;
        case LLM_ARCH_QWEN3VL:
        case LLM_ARCH_QWEN3VLMOE:
        case LLM_ARCH_QWEN35:
        case LLM_ARCH_QWEN35MOE:
        case LLM_ARCH_QWEN35_MTP:
        case LLM_ARCH_QWEN35MOE_MTP:
            return EDEN_ROPE_TYPE_IMROPE;

        case LLM_ARCH_GLM4:
            return model->hparams.use_mrope() ? EDEN_ROPE_TYPE_MROPE : EDEN_ROPE_TYPE_NORM;
        case LLM_ARCH_GLM4_MOE:
            return model->hparams.use_mrope() ? EDEN_ROPE_TYPE_MROPE : EDEN_ROPE_TYPE_NEOX;
...
float eden_model_rope_freq_scale_train(const eden_model * model) {
    return model->hparams.rope_freq_scale_train;
}

int32_t eden_model_meta_val_str(const eden_model * model, const char * key, char * buf, size_t buf_size) {
...
int32_t eden_model_meta_count(const eden_model * model) {
    return (int)model->gguf_kv.size();
}

const char * eden_model_meta_key_str(eden_model_meta_key key) {
    switch (key) {
        case EDEN_MODEL_META_KEY_SAMPLING_SEQUENCE:        return "general.sampling.sequence";
        case EDEN_MODEL_META_KEY_SAMPLING_TOP_K:           return "general.sampling.top_k";
        case EDEN_MODEL_META_KEY_SAMPLING_TOP_P:           return "general.sampling.top_p";
        case EDEN_MODEL_META_KEY_SAMPLING_MIN_P:           return "general.sampling.min_p";
        case EDEN_MODEL_META_KEY_SAMPLING_XTC_PROBABILITY: return "general.sampling.xtc_probability";
        case EDEN_MODEL_META_KEY_SAMPLING_XTC_THRESHOLD:   return "general.sampling.xtc_threshold";
        case EDEN_MODEL_META_KEY_SAMPLING_TEMP:            return "general.sampling.temp";
        case EDEN_MODEL_META_KEY_SAMPLING_PENALTY_LAST_N:  return "general.sampling.penalty_last_n";
        case EDEN_MODEL_META_KEY_SAMPLING_PENALTY_REPEAT:  return "general.sampling.penalty_repeat";
        case EDEN_MODEL_META_KEY_SAMPLING_MIROSTAT:        return "general.sampling.mirostat";
        case EDEN_MODEL_META_KEY_SAMPLING_MIROSTAT_TAU:    return "general.sampling.mirostat_tau";
        case EDEN_MODEL_META_KEY_SAMPLING_MIROSTAT_ETA:    return "general.sampling.mirostat_eta";
        default:                                            return nullptr;
    }
}

int32_t eden_model_meta_key_by_index(const eden_model * model, int i, char * buf, size_t buf_size) {
...
int32_t eden_model_meta_val_str_by_index(const eden_model * model, int32_t i, char * buf, size_t buf_size) {
    if (i < 0 || i >= (int)model->gguf_kv.size()) {
        if (buf_size > 0) {
            buf[0] = '\0';
        }
...
int32_t eden_model_desc(const eden_model * model, char * buf, size_t buf_size) {
    return snprintf(buf, buf_size, "%s", model->desc().c_str());
}

uint64_t eden_model_size(const eden_model * model) {
    return model->size();
}

const char * eden_model_chat_template(const eden_model * model, const char * name) {
    ...
    if (it == model->gguf_kv.end()) {
        ...
        eden_vocab_pre_type pre_type = model->vocab.get_pre_type();
        if (!name && pre_type == EDEN_VOCAB_PRE_TYPE_TEKKEN && model->layers.size() == 40) {
        if (!name && model->arch == LLM_ARCH_GEMMA4) {
            return "{{ bos_token }}{% for message in messages %}{% if message[\"role\"] == \"user\" %}<start_of_turn>user\n{{ message[\"content\"] }}<end_of_turn>\n{% elif message[\"role\"] == \"assistant\" %}<start_of_turn>model\n{{ message[\"content\"] }}<end_of_turn>\n{% endif %}{% endfor %}<start_of_turn>model\n";
        }
...
uint64_t eden_model_n_params(const eden_model * model) {
    return model->n_elements();
}

bool eden_model_has_encoder(const eden_model * model) {
    switch (model->arch) {
...
bool eden_model_has_decoder(const eden_model * model) {
    switch (model->arch) {
...
eden_token eden_model_decoder_start_token(const eden_model * model) {
    return model->hparams.dec_start_token_id;
}

bool eden_model_is_recurrent(const eden_model * model) {
    return llm_arch_is_recurrent(model->arch);
}

bool eden_model_is_hybrid(const eden_model * model) {
    return llm_arch_is_hybrid(model->arch);
}

bool eden_model_is_diffusion(const eden_model * model) {
    return llm_arch_is_diffusion(model->arch);
}

const std::vector<std::pair<std::string, ggml_tensor *>> & eden_internal_get_tensor_map(const eden_model * model) {
    return model->tensors_by_name;
}

int32_t eden_model_n_expert(const struct eden_model * model) {
    return model->hparams.n_expert;
}

int32_t eden_model_n_devices(const struct eden_model * model) {
    return (int32_t)model->devices.size();
}

ggml_backend_dev_t eden_model_get_device(const struct eden_model * model, int i) {
...
eden_model_base::eden_model_base(const struct eden_model_params & params) : eden_model(params), model(this), tn(model->arch),
    TENSOR_DUPLICATED     (eden_model_loader::TENSOR_DUPLICATED),
    TENSOR_NOT_REQUIRED   (eden_model_loader::TENSOR_NOT_REQUIRED),
    TENSOR_SKIP           (eden_model_loader::TENSOR_SKIP),
    TENSOR_SKIP_IF_VIRTUAL(eden_model_loader::TENSOR_SKIP_IF_VIRTUAL) {}

ggml_tensor * eden_model_base::create_tensor(const LLM_TN_IMPL & tn, const std::initializer_list<int64_t> & ne, int flags) {
    GGML_ASSERT(ml != nullptr);
    return create_tensor(*ml, tn, ne, flags);
}

void eden_model_base::create_tensor_gate_up_exps(eden_layer & layer, int bid, int64_t n_embd_, int64_t n_ff_, int64_t n_expert_, int flags) {
...
void eden_model_base::create_tensor_qkv(eden_layer & layer, int bid,
